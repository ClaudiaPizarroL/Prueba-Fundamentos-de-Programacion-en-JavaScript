$(document).ready(function() {
    $('#searchForm').submit(function(event) {
        ...
        // Crear la constante del superhéroe ingresado
        const heroId = $("#heroId").val();

// Validar el número de heroId
    ...
    return;
        ...
        $.ajax({
            ...
            success: function(response) {
                // Mostrar la información del superhéroe en tarjetas de Bootstrap
                const heroInfo = `
                ...
                // Generar el gráfico de pastel con CanvasJS
                const chartData = [];
